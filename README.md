...
<li>Dynamic repositioning on Desktop, Tablet, and Mobile viewport sizes. </li> 
<li>Hero text animation on initial site load.</li>  
<li>Expand on click items in the <b>Expertise</b> section.</li>
<li>On hover website images for every <b>Recent Projects</b> item.</li>
<li>Pop up modal for every link within the <b>Recent Projects</b> section.</li>
<li><b>Back to top</b> button in footer. </li>
<li>Mailto: instant email feature.</li>
<li>Within the <b>Try It Yourself</b> virtual desktop section, features include:</li>
    <ul>
    <li>Draggable icons.</li>
    <li>Draggable music player with 10 song playlist, pause button, next button, previous button, close X, and reopen feature.</li>
    <li>Section pin to task bar on open with indicator.</li>
    <li>Full feature Start Button with icons.</li>
...
Live link: "https://christian-schneider-davis.github.io/Christian-Schneider-Davis-Web-Dev-Portfolio/"
